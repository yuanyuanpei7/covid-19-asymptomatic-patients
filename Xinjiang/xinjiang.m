...
title('Fitting in Xinjiang')
%%%%% plot asymptomatic
tspan1=1:length(Ipresent(:,1))+6;
...
%%%%%%%%%%%%%%%%%% show the dynamic transmission coefficien %%%%%%%%%%%%
figure(2)
hold on;
